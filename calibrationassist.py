...
def main():
	...
	while correct_Entry == False:
		if typeOfCal == "Words" or typeOfCal == "words":
			...
			main_words(calibrated)
		elif typeOfCal == "Phrases" or typeOfCal == "phrases":
			correct_Entry = True
			csvFile = raw_input("Please enter the path to the file: \n")
			phrases = readCSV_Phrases(csvFile)
			# run the calibration loop for phrases
			main_phrases(calibrated, phrases)
		else:
